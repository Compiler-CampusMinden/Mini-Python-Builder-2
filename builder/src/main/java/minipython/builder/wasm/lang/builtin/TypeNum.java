...
import static minipython.builder.wasm.lang.RuntimeImports.MPY_BUILTINS_GET_TYPE_NUM;
...
public class TypeNum implements Expression {


    @Override
    public BlockContent buildExpression(MPyModule partOf) {
        partOf.declareRuntimeImport(MPY_BUILTINS_GET_TYPE_NUM);
        return new Line("call $__mpy_builtins_get_type_num");
    }
    ...
    public BlockContent buildStatement(MPyModule partOf) {
        ...
        // is simply a no-op
        return new Line("", "builtin num type");
    }
}

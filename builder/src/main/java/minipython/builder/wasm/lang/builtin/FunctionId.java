...
import static minipython.builder.wasm.lang.RuntimeImports.MPY_BUILTINS_GET_FN_ID;
 ...
 */
public class FunctionId implements Expression {

	@Override
	public BlockContent buildExpression(MPyModule partOf) {
        partOf.declareRuntimeImport(MPY_BUILTINS_GET_FN_ID);
        return new Line("call $__mpy_builtins_get_fn_id");
	}

...
import static minipython.builder.wasm.lang.RuntimeImports.MPY_BUILTINS_GET_TYPE_TUPLE;
...
public class TypeTuple implements Expression {


    @Override
    public BlockContent buildExpression(MPyModule partOf) {
        partOf.declareRuntimeImport(MPY_BUILTINS_GET_TYPE_TUPLE);
        return new Line("call $__mpy_builtins_get_type_tuple");
    }
    ...
    public BlockContent buildStatement(MPyModule partOf) {
        ...
        // is simply a no-op
        return new Line("", "builtin tuple type");
    }
}
